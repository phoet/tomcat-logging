...
Maven is a stupid fuck, so it will create your application with Java 1.4 compatibility by default. You need to fix this in the pom by changing the compiler plugin:
