...
h2. Using it from the command-line

TODO
Set the M2_REPO path and sets 1.4 compiler, which sucks ass very much. It also restarts the whole container without hotcode replacement which sucks even more.
